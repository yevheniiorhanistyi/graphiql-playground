...
export const teamData: TeamMember[] = [
  {
    ...
    bio: [
      'Stanislav, an excellent example of a team player, but is also capable of working alone.',
  ...
  },
  {
    ...
    role: 'Frontend Developer',
    bio: [
      'Uladzimir is web developer with excellent communication skills  shows an outstanding ability to adapt to new technologies, which makes it an ideal candidate for projects that require implementation of new solutions.',
    ],
  ...
  },
  {
    ...
    role: 'Frontend Developer',
    bio: [
      'Yevhenii is a passionate web developer, dedicated to delivering top-notch solutions that prioritize user experience, architectural soundness, and code quality. His multifaceted approach  makes him an asset to any project or team.',
    ],
